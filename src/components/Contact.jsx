...
import "../index.css";
import './Contacthtmlcss/Contact.css'; // Assuming you still want to import the CSS file

const Contact = () => {
  return (
    <div className="main  ">
      <div className="up flex align-center justify-center">
        <a href="https://www.instagram.com/callmeashwanig/" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://x.com/AshwaniTi64342" target="_blank" rel="noopener noreferrer">
      ...
      <div className="down flex align-center justify-center">
        <a href="https://github.com/Ashwani-Kumar-tripathi" target="_blank" rel="noopener noreferrer">
        ...
        <a href="mailto:a77tripathi@gmail.com" target="_blank" rel="noopener noreferrer">
